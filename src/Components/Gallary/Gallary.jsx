...
const Gallary = () => {
    return (
        ...
        data-aos-duration="1500" className="w-full h-[450px] rounded-md col-span-2" src="https://i.ibb.co/54b348m/download.jpg" alt="" />
     ...
     data-aos-duration="2000" className="w-full h-[450px] rounded-md col-span-2" src="https://i.ibb.co/bHYLjkq/download.jpg" alt="" />
                 <img   data-aos="fade-right"
        data-aos-easing="linear"
        data-aos-duration="1500" className="w-full h-[450px] rounded-md col-span-2" src="https://i.ibb.co/w4VKQR6/images.jpg" alt="" />
